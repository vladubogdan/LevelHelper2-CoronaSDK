...
function scene:show( event )
	...
	if phase == "will" then
		...
		lhScene = LHScene:initWithContentOfFile("publishFolder/gearJointLevel.json");
	
		sceneGroup:insert(lhScene);
	
		local myString = "GEAR JOINTS";
		...
		self.demoButtons:createButtonsWithComposerScene(self, "gearJointsExample");
