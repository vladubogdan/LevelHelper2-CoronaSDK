-----------------------------------------------------------------------------------------
--
-- simpleNonSpriteSheetAnimation.lua
--
-----------------------------------------------------------------------------------------
...
function scene:show( event )
	...
	if phase == "will" then
		...
		local demoHelpString = "Character Animation\nThis is a non Sprite Sheet Animation\nIt uses less memory then traditional sprite sheet animations";
